...
from birdwatcher.media import save_bird_image
from birdwatcher.models import format_species_name
...
class CoreLogicTests(unittest.TestCase):
    ...
    def test_small_saved_crop_is_upscaled(self):
        ...
        with TemporaryDirectory() as temp, patch("birdwatcher.media.cv2", FakeCV2WithResize):
            path = save_bird_image(
                small,
                Path(temp),
                "test_species",
    ...
    def test_species_name_is_human_readable(self):
        self.assertEqual(
            format_species_name("BLACK-CAPPED CHICKADEE"),
